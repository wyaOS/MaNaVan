    ...
    <SiteLayout>
      ...
      <section className="relative flex min-h-[88vh] items-end overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-5 py-16 md:py-24">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a
              href={whatsappMessage(t.waMessages.general)}
              target="_blank"
            ...
            {tours.map((tour) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-6">
                  <h3 className="text-lg font-bold leading-snug text-terracotta">{tour.title}</h3>
                  <p className="mt-2 flex-1 text-sm text-muted-foreground">{tour.short}</p>
                  <a
      ...
      <section className="mx-auto max-w-4xl px-5 py-20 text-center">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <a
            href={whatsappMessage(t.waMessages.plan)}
            target="_blank"
            rel="noopener noreferrer"
